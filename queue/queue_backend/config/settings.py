...
SECRET_KEY = "django-insecure-=!1*^=5$^c&$lpg$l5q1@xm$)lty^egvbpz!k1*v@3z8$&f$07"
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Queue Producer API',
    'DESCRIPTION': 'Django REST API that produces tasks to RabbitMQ',
    'VERSION': '1.0.0',
